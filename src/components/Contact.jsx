  ...
  return (
    <section className='bg-primary  py-20 lg:py-28 overflow-hidden' id='Contact'>
        <div className='max-w-[540px] lg:max-w-[1140px] mx-auto px-3'> 
            ...
            <div className='animate-fadeInUp' data-aos="fade-up" data-aos-offset="200" data-aos-duration="200">
                <div className='flex flex-wrap -mt-7 -mx-6'>
                    ...
                    <div className='w-full lg:w-[33.33%] px-6 mt-12'>
                        <ul className='contact-info'>
                            <li className='bg-[rgba(255,255,255,0.1)] mb-5 gap-5 py-6 px-8 flex items-center border border-[rgba(255,255,255,0.1)]'>
                                <div className='flex-shrink-0 h-[50px] w-[50px] flex items-center justify-center rounded-full bg-gold text-center text-2xl'>
                                    <FaPhone />
                                </div>
                                <div className='contact-content text-white'>
                                    <h4 className=' text-xl font-semibold mb-1'>Phone Number</h4>
                                    <a href="tel:+2348144098649">+2348144098649</a>
                            ...
                            <li className='bg-[rgba(255,255,255,0.1)] mb-5 gap-5 py-6 px-8 flex items-center border border-[rgba(255,255,255,0.1)]'>
                                ...
                                <div className='contact-content text-white'>
                                    ...
                                    <a href="mailto:godwinhigh2@gmail.com">godwinhigh2@gmail.com</a>
                    ...
                    {/* Left Content End */}
                     ...
                     {/* Right Content Start */}
                     <div className='w-full lg:w-[66.66%] px-6 mt-7'>
                        <form action="" onSubmit={sendToWhatsApp}>
                            <div className='flex flex-wrap'>
                                <div className='w-full lg:w-2/4 px-3 mt-6'>
                                    <input type="text" id='name' placeholder='Your Name' className='block w-full text-base font-normal text-white border border-[rgba(255,255,255,0.1)] px-5 py-4 bg-[rgba(255,255,255,0.1)] transition-all duration-300 focus:border-gold focus:outline-0' />
                                </div>
                                <div className='w-full lg:w-2/4 px-3 mt-6'>
                                    <input type="text" id='email' placeholder='Your Email' className='block w-full text-base font-normal text-white border border-[rgba(255,255,255,0.1)] px-5 py-4 bg-[rgba(255,255,255,0.1)] transition-all duration-300 focus:border-gold focus:outline-0' />

                                </div>

                                <div className='w-full px-3 mt-6'>
                                    <textarea  id='message' placeholder='Your Message' className=' min-h-[250px] block w-full text-base font-normal text-white border border-[rgba(255,255,255,0.1)] px-5 py-4 bg-[rgba(255,255,255,0.1)] transition-all duration-300 focus:border-gold focus:outline-0' />
